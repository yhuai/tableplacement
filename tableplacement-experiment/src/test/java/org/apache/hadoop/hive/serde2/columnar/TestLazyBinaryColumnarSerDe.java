...
public class TestLazyBinaryColumnarSerDe extends TestCase {
  ...
  public void testSerDe() throws SerDeException {
    StructObjectInspector oi = (StructObjectInspector) ObjectInspectorFactory
        .getReflectionObjectInspector(OuterStruct.class,
    ...
    BytesRefArrayWritable braw = (BytesRefArrayWritable) serde.serialize(
        outerStruct, oi);

    ObjectInspector out_oi = serde.getObjectInspector();
    Object out_o = serde.deserialize(braw);
    if (0 != ObjectInspectorUtils.compare(outerStruct, oi, out_o, out_oi,
        new CrossMapEqualComparer())) {
  ...
  public void testLazyBinaryColumnarSerDeWithEmptyBinary()
    ...
    try {
      ...
      assertEquals(
          re.getMessage(),
          "LazyBinaryColumnarSerde cannot serialize a non-null "
