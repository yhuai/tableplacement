...
public class TrevniMultiFileRowInputFormat <K extends LongWritable, V extends MapWritable>
extends FileInputFormat<K, V> implements InputFormatChecker{

	public TrevniMultiFileRowInputFormat() {
	...
	public RecordReader<K, V> getRecordReader(InputSplit split, JobConf job,
		...
		try {
			return new TrevniMultiFileRowRecordReader(job, (FileSplit) split);
