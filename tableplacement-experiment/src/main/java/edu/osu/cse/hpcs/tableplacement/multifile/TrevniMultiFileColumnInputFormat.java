...
public class TrevniMultiFileColumnInputFormat <K extends LongWritable, V extends MapWritable>
extends FileInputFormat<K, V> implements InputFormatChecker{

	public TrevniMultiFileColumnInputFormat() {
	...
	public RecordReader<K, V> getRecordReader(InputSplit split, JobConf job,
		...
		try {
			return new TrevniMultiFileColumnRecordReader(job, (FileSplit) split);
