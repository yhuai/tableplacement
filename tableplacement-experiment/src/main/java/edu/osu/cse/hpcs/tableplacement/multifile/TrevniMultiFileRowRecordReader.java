...
public class TrevniMultiFileRowRecordReader <K extends LongWritable, V extends TPMapWritable>
implements RecordReader<LongWritable, TPMapWritable> {

	private final long start;
	private final long end; 
	private TrevniMultiFileRowReader reader; 
	protected Configuration conf;
	
	public TrevniMultiFileRowRecordReader(Configuration conf, 
		...
		this.reader = new TrevniMultiFileRowReader(conf, inDir, readColumns, false);
		this.conf = conf;
		this.start = 0;
