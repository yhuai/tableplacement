...
iostat -d -t $DEVICE
#strace -F -f -ttt -T
java -jar ../target/tableplacement-experiment-0.0.1-SNAPSHOT.jar ReadTrevniRowOriented -t ../tableProperties/$TABLE -i $OUT_DIR/ -p read.column.string $READ_COLUMN_STR -p io.file.buffer.size $IO_BUFFER_SIZE
